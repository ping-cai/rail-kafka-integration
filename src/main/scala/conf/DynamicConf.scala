...
object DynamicConf extends Serializable {
  ...
  val streamCheckPoint: String = conf.getString("stream.checkPoint")
  ...
  val netWorkLoadDelayThreshold: String = conf.getString("dynamic.streaming.netWorkLoad.delayThreshold")
